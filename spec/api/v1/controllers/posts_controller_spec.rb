...
RSpec.describe Api::V1::PostsController, type: :controller do
   ...
   # ===========================================================================
    context "unauthenticated user" do
     ...
     it "PUT update returns http unauthenticated" do
       put :update, id: my_post.id, post: {title: "Post Title", body: "Post Body must be 20 characters long"}
       expect(response).to have_http_status(401)
     end

     it "POST create returns http unauthenticated" do
       post :create, post: {title: "Post Title", body: "Post Body must be 20 characters long"}
       expect(response).to have_http_status(401)
     end
   ...
   # ===========================================================================
    context "unauthorized user" do
     ...
     it "POST create returns http forbidden" do
      post :create, topic: my_topic, post: {title: "Post Title", body: "Post Body must be 20 characters long"}
      expect(response).to have_http_status(403)
     end
   ...
   context "authenticated and authorized users" do
      ...
      describe "POST create" do
         before { post :create, topic: my_topic, user: my_user, post: {title: @new_post.title, body: @new_post.body} }
